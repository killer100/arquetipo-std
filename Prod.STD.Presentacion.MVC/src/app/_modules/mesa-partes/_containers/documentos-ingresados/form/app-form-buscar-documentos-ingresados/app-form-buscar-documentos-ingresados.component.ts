...
const DEFAULT_FORM = {
    coddep: null,
    fecha_inicio: moment().startOf('day').utc(true),
    fecha_fin: moment().endOf('day').utc(true),
    estado: 1
};

@Component({
    selector: "app-form-buscar-documentos-ingresados",
    templateUrl: "./app-form-buscar-documentos-ingresados.component.html",
    styles: []
})
export class AppFormBuscarDocumentosIngresadosComponent implements OnInit {
    @Input()
    onSubmit: Function;
    @Input()
    disabled: Boolean;
