...
{
    public class DocumentoExternoComandoProxy : BaseProxy
    {
        private readonly string _url;

        public DocumentoExternoComandoProxy(AppConfig appConfig)
        {
            _url = $"{appConfig.Urls.URL_STD_Core_API}/documentoExternoComando";
        }
